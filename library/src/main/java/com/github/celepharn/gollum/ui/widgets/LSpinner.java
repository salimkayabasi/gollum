...
public class LSpinner<T extends Parcelable> extends AppCompatSpinner {
    ...
    private static final int DEFAULT_COLOR = R.color.material_blue_grey_800;
    ...
    private void initialize(final Context context, AttributeSet attrs, int defStyle) {
        if (attrs != null) {
            ...
            titleColor = types.getColor(R.styleable.LSpinner_lspinner_title_color, DEFAULT_COLOR);
            ...
            if (types.hasValue(R.styleable.LSpinner_lspinner_positive_text)) {
                positiveText = types.getString(R.styleable.LSpinner_lspinner_positive_text);
            }
    ...
    private void showDialog(Context context) {
        ...
        if (!TextUtils.isEmpty(titleString)) {
            builder.title(titleString).titleColorRes(titleColor);
        }
